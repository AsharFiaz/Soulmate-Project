        ...
        <>
            ...
            <div className='footer-container'>
                ...
                <div className='social-media'>
                    ...
                    <li><a href = 'https://www.facebook.com/'><MdOutlineFacebook/>Facebook</a></li>
                    <li><a href = 'https://www.instagram.com/accounts/login/?hl=en'><CiInstagram/>    Instagram</a></li>
                    <li><a href = '#home'><FaTwitter/>      Twiter</a></li>
                </div>
                <div className='successful-stories'>
                    <h6> SuccessFul Stories</h6>
                    <li><a href = '/stories'>Muslim stories</a></li>
                    <li><a href = '/stories'>Hindu</a></li>
                    <li><a href = '/stories'>Others</a></li>
                </div>
